package com.olimpiodev.tec.carteira.adapter;
...
public class LancamentoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (lancamento.getTipo().equals(TipoLancamento.ENTRADA.toString())) {
            textViewLancamentoValorLista.setTextColor(activity.getResources().getColor(R.color.primary_dark));
        } else if (lancamento.getTipo().equals(TipoLancamento.SAIDA.toString())) {
